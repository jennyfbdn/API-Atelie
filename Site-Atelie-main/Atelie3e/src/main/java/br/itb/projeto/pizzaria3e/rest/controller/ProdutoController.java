...
public class ProdutoController {
	...
	public ResponseEntity<?> alterar(
		...
		Produto _produto = produtoService.alterar(id, file, produto);
		...
		throw new ResourceNotFoundException("Erro ao alterar produto!");
	}
	...
	public ResponseEntity<?> inativar(@PathVariable long id) {
		...
		if(produto != null) {
			return ResponseEntity.ok()
					.body(new MessageResponse("Produto inativado com sucesso!"));
		}
		
		throw new ResourceNotFoundException("Erro ao inativar produto!");
	}
	...
	public ResponseEntity<?> reativar(@PathVariable long id) {
		...
		if(produto != null) {
			return ResponseEntity.ok()
					.body(new MessageResponse("Produto reativado com sucesso!"));
		}
		
		throw new ResourceNotFoundException("Erro ao reativar produto!");
	}

	@GetMapping("/sync")
	public ResponseEntity<List<Produto>> syncProdutos(){
		List<Produto> produtos = produtoService.findAllAtivos();
		return new ResponseEntity<List<Produto>>(produtos, HttpStatus.OK);
	}
}
